...
export default function FeedbackView({ tableId, fromPayment = false }: Props) {
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-gray-400 text-sm mb-10">Your opinion helps us improve the experience.</p>
          <a
            href={`/table/${tableId}`}
    ...
    <div className="min-h-screen bg-background px-6 py-10">
      <div className="w-full max-w-sm mx-auto">
        <div className="flex items-center gap-3 mb-8">
          <a
            href={fromPayment ? `/table/${tableId}` : `/table/${tableId}`}
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Leave feedback</h1>
        <p className="text-gray-400 text-sm mb-8">How was your experience at Table N°{tableId}?</p>

        {/* Star rating */}
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-4">
          <p className="text-sm font-medium text-gray-700 mb-4 text-center">Rate your experience</p>
          ...
          {active > 0 && (
            <p className="text-center text-sm font-medium text-brand transition-all">
              {LABELS[active]}
            </p>
          )}
        </div>
